...
function(${args}) {
  ...
  function finalCombiner() {
    ...
    if (!OPT_LEVEL) {
      ...
      print('// cDefs only exists in debug builds. In release builds these contants are inlined')
      print('var cDefs = ' + stringify(defines, 0) + ';');
      print('// cStructs only exists in debug builds. In release builds these contants are inlined')

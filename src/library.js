...
addToLibrary({
  ...
  strftime_l: (s, maxsize, format, tm, loc) => {
    return strftime(s, maxsize, format, tm); // no locale support yet
  },
  ...
  emscripten_get_now: `;
    ...
    // N.B. a shorter form "emscripten_get_now = performance.now;" is
...
`,
  ...
  emscripten_get_compiler_setting: (name) => {
    ...
    if (!emscripten_get_compiler_setting.cache) emscripten_get_compiler_setting.cache = {};

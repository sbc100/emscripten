...
#
# Various compiler settings. These are available as simply JS variables when
# the JS compiler runs, or via the `settings` object in the python runtime.
#
...
# size increases.
# [link]
MEMORY_GROWTH_GEOMETRIC_CAP = 96 * 1024 * 1024
...
# [link]
DEFAULT_PTHREAD_STACK_SIZE = 2 * 1024 * 1024

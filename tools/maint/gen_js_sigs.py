...
def write_sig_library(filename, sig_info):
  lines = [
      '/* Auto-generated by tools/maint/gen_js_sigs.py. DO NOT EDIT. */',
      '',
      'sigs = {',
  ]
...
def extract_sig_info(sig_info, extra_settings=None, extra_cflags=None, cxx=False):
  ...
  settings_json = utils.path_from_root('out/gen_js_sigs_settings.json')
  ...
  c_file = utils.path_from_root('out/gen_js_sigs' + ext)

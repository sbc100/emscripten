...
after *emcc* (use *em++* to force compilation as C++): ::
  ...
  ./emcc test/hello_world.c -o out.js

You should see two files generated by that command: **out.js** and
**out.wasm**. The second is a WebAssembly file containing the compiled code,
...
line argument: ::
    ...
    ./emcc -O1 test/hello_world.cpp -o out.js

The "hello world" code created in **out.js** doesn't really need to be
...
(**out.js**) you will see that it looks very different: ::

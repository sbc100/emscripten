...
test_t g_tests[] = {
    ...
    { "simulateKeyDown('Backspace')", { 0, 0.0, 0.0, GLFW_KEY_BACKSPACE, GLFW_PRESS, -1 } },
    { "simulateKeyUp  ('Backspace')", { 0, 0.0, 0.0, GLFW_KEY_BACKSPACE, GLFW_RELEASE, -1 } },
    { "simulateKeyDown('Tab')", { 0, 0.0, 0.0, GLFW_KEY_TAB, GLFW_PRESS, -1 } },
    { "simulateKeyUp  ('Tab')", { 0, 0.0, 0.0, GLFW_KEY_TAB, GLFW_RELEASE, -1 } },
    { "simulateKeyDown('F1')", { 0, 0.0, 0.0, GLFW_KEY_F1, GLFW_PRESS, -1 } },
    { "simulateKeyUp  ('F1')", { 0, 0.0, 0.0, GLFW_KEY_F1, GLFW_RELEASE, -1 } },
    { "simulateKeyDown('ArrowLeft')", { 0, 0.0, 0.0, GLFW_KEY_LEFT, GLFW_PRESS, -1 } },
    { "simulateKeyUp  ('ArrowLeft')", { 0, 0.0, 0.0, GLFW_KEY_LEFT, GLFW_RELEASE, -1 } },
    { "simulateKeyDown('ArrowRight')", { 0, 0.0, 0.0, GLFW_KEY_RIGHT, GLFW_PRESS, -1 } },
    { "simulateKeyUp  ('ArrowRight')", { 0, 0.0, 0.0, GLFW_KEY_RIGHT, GLFW_RELEASE, -1 } },
    { "simulateKeyDown('ArrowUp')", { 0, 0.0, 0.0, GLFW_KEY_UP, GLFW_PRESS, -1 } },
    { "simulateKeyUp  ('ArrowUp')", { 0, 0.0, 0.0, GLFW_KEY_UP, GLFW_RELEASE, -1 } },
    { "simulateKeyDown('ArrowDown')", { 0, 0.0, 0.0, GLFW_KEY_DOWN, GLFW_PRESS, -1 } },
    { "simulateKeyUp  ('ArrowDown')", { 0, 0.0, 0.0, GLFW_KEY_DOWN, GLFW_RELEASE, -1 } },
    #if USE_GLFW == 2
        { "simulateKeyDown('Escape')", { 0, 0.0, 0.0, GLFW_KEY_ESC, GLFW_PRESS, -1 } },
        { "simulateKeyUp('Escape')", { 0, 0.0, 0.0, GLFW_KEY_ESC, GLFW_RELEASE, -1 } },

        { "simulateKeyDown('KeyA')", { 0, 0.0, 0.0, 'A', GLFW_PRESS, -1, 'A' } },
        { "simulateKeyEvent('keypress', 'KeyA')", { 0, 0.0, 0.0, -1, -1, -1, 'A' } },
        { "simulateKeyUp('KeyA')", { 0, 0.0, 0.0, 'A', GLFW_RELEASE, -1, 'A' } },

        { "simulateKeyDown('KeyA', {ctrlKey: true})", { 0, 0.0, 0.0, 'A', GLFW_PRESS, -1, 'A' } },
        { "simulateKeyEvent('keypress', 'KeyA', {ctrlKey: true, charCode: 65})", { 0, 0.0, 0.0, -1, -1, -1, -1 } },
        { "simulateKeyUp('KeyA', {ctrlKey: true})", { 0, 0.0, 0.0, 'A', GLFW_RELEASE, -1, 'A' } },
    #else
        { "simulateKeyDown('Escape')", { 0, 0.0, 0.0, GLFW_KEY_ESCAPE, GLFW_PRESS, -1 } },
        { "simulateKeyUp('Escape')", { 0, 0.0, 0.0, GLFW_KEY_ESCAPE, GLFW_RELEASE, -1 } },

        { "simulateKeyDown('KeyA')", { 0, 0.0, 0.0, GLFW_KEY_A, GLFW_PRESS, -1 } },
        { "simulateKeyEvent('keypress', 'KeyA', {charCode: 65})", { 0, 0.0, 0.0, -1, -1, -1, 'A' } },
        { "simulateKeyUp('KeyA')", { 0, 0.0, 0.0, GLFW_KEY_A, GLFW_RELEASE, -1 } },

        { "simulateKeyDown('KeyA', {ctrlKey: true})", { 0, 0.0, 0.0, GLFW_KEY_A, GLFW_PRESS, -1, 'A' } },
        { "simulateKeyEvent('keypress', 'KeyA', {ctrlKey: true})", { 0, 0.0, 0.0, -1, -1, -1, -1 } },
        { "simulateKeyUp('KeyA', {ctrlKey: true})", { 0, 0.0, 0.0, GLFW_KEY_A, GLFW_RELEASE, -1, 'A' } },
    #endif
};

...
int main(int argc, char *argv[])
{
  ...
  emscripten_run_script("simulateKeyDown('ArrowLeft');"); // left
  loop1();
  emscripten_run_script("simulateKeyDown('ArrowRight');"); // right
  loop2();
  emscripten_run_script("simulateKeyDown('KeyA', 'a');"); // A
  alphakey();
  return 0;
}

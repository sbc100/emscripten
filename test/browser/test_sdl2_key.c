...
int main(int argc, char **argv) {
  ...
  emscripten_run_script("simulateKeyDown('ArrowUp');   simulateKeyUp('ArrowUp')"); // up
  emscripten_run_script("simulateKeyDown('ArrowDown'); simulateKeyUp('ArrowDown')"); // down
  emscripten_run_script("simulateKeyDown('ArrowLeft'); simulateKeyUp('ArrowLeft');"); // left
  emscripten_run_script("simulateKeyDown('ArrowRight');simulateKeyUp('ArrowRight');"); // right
  emscripten_run_script("simulateKeyDown('KeyA', 'A'); simulateKeyUp('KeyA', 'A');"); // a
  emscripten_run_script("simulateKeyDown('KeyB', 'B'); simulateKeyUp('KeyB', 'B');"); // b
  emscripten_run_script("simulateKeyDown('Numpad4');   simulateKeyUp('Numpad4');"); // trigger the end
